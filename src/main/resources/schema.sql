...
create table if not exists bookings(
  ...
  constraint fk_book_room  foreign key (hotel_id, room_id) references rooms(hotel_id, room_id) on delete cascade,
  constraint fk_book_guest foreign key (guest_id) references guests(guest_id) on delete cascade,
